...
_Làm nhiều hơn khi điện sạch hơn và làm ít hơn khi điện bẩn hơn._

:::

## Giới thiệu

Không phải tất cả điện đều được sản xuất theo cùng một cách. Ở các địa điểm và thời gian khác nhau, điện được tạo ra bằng nhiều nguồn khác nhau với mức phát thải carbon khác nhau. Một số nguồn, như gió, mặt trời hoặc thủy điện, là các nguồn tái tạo sạch, ít phát thải carbon. Ngược lại, các nguồn nhiên liệu hóa thạch phát thải carbon ở mức độ khác nhau để tạo ra điện. Ví dụ, cả khí đốt và than đều phát thải nhiều carbon hơn các nguồn tái tạo, nhưng nhà máy phát điện chạy bằng khí đốt phát thải ít carbon hơn nhà máy phát điện chạy bằng than.

Tính nhận thức về carbon là ý tưởng làm nhiều hơn khi năng lượng từ các nguồn ít phát thải carbon và làm ít hơn khi năng lượng từ các nguồn nhiều phát thải carbon.
